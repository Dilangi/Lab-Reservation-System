...
var appRoutes = [
    ...
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_12__["DashboardComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_16__["AuthGuard"]] },
...
module.exports = ".jumbotron {\r\n    width:1020px;\r\n}\r\n\r\n.jumbotron #calendar-icon {\r\n    width:100px;\r\n    height: 100px;\r\n    position: relative;\r\n    left: 600px;\r\n    bottom: 100px;\r\n}\r\n\r\n.jumbotron #settings-icon {\r\n    width:100px;\r\n    height: 100px;\r\n    position: relative;\r\n    left: 500px;\r\n}\r\n\r\n.jumbotron #analytics-icon {\r\n    width:100px;\r\n    height: 100px;\r\n    position: relative;\r\n    left: 700px;\r\n    bottom: 100px;\r\n\r\n}\r\n\r\n.features .inline_block {\r\n    display: inline-block;\r\n    width: 300px;\r\n    height: 300px;\r\n    padding: 20px;\r\n    margin-left: 40px;\r\n}\r\n\r\n.features .inline_block #card-b {\r\n    float: right;\r\n    position: relative;\r\n    left: 300px;\r\n    bottom: 230px;\r\n}\r\n\r\n.features .inline_block #card-c {\r\n    position: relative;\r\n    left: 600px;\r\n    bottom: 460px;\r\n}\r\n\r\n.features .card {\r\n    border-color: rgb(238, 107, 14);\r\n    box-shadow: 2px 2px 5px rgb(238, 107, 14);\r\n    border-radius: 3%;\r\n}"
...
module.exports = "\n<br>\n<div class=\"jumbotron\">\n    <h1 class=\"display-3\">Lab Reservations</h1>\n    <p class=\"lead\">Welcome to Online Lab Reservation Application of UCSC</p>\n    <img id =\"calendar-icon\" src=\"../../../assets/img/calendar-icon.png\">\n    <img id=\"analytics-icon\" src=\"../../../assets/img/analytics-icon.png\">\n    <img id=\"settings-icon\" src=\"../../../assets/img/settings-icon.png\">\n    <hr class=\"my-4\">\n    <div class=\"lead\">\n        <a class=\"btn btn-primary\" [routerLink] = \"['/register']\" style=\"margin-right: 20px\">Register</a>\n        <a class=\"btn btn-success\" [routerLink] = \"['/login']\">Login</a> \n    </div>\n  </div>\n    <div class=\"features\">\n        <h1>Extensive Feature Support</h1>\n        <span class=\"inline_block\">\n            <div class=\"card my-md-4\" id=\"card-a\">\n                <div class=\"card-body\">\n                <h4 class=\"card-title\">Visibility</h4>\n                <h6 class=\"card-subtitle mb-2 text-muted\"><br></h6>\n                <p class=\"card-text\">Some quick example text to build on the card title and make up the bulk of the card's content.</p>\n                <a href=\"#\" class=\"card-link\">Card link</a>\n                <a href=\"#\" class=\"card-link\">Another link</a>\n                </div>\n            </div>\n            <div class=\"card my-md-4\" id=\"card-b\">\n                <div class=\"card-body\">\n                <h4 class=\"card-title\">Activity</h4>\n                <h6 class=\"card-subtitle mb-2 text-muted\"><br></h6>\n                <p class=\"card-text\">Some quick example text to build on the card title and make up the bulk of the card's content.</p>\n                <a href=\"#\" class=\"card-link\">Card link</a>\n                <a href=\"#\" class=\"card-link\">Another link</a>\n                </div>\n            </div>\n            <div class=\"card my-md-4\" id=\"card-c\">\n                <div class=\"card-body\">\n                <h4 class=\"card-title\">Notifications</h4>\n                <h6 class=\"card-subtitle mb-2 text-muted\"><br></h6>\n                <p class=\"card-text\">Some quick example text to build on the card title and make up the bulk of the card's content.</p>\n                <a href=\"#\" class=\"card-link\">Card link</a>\n                <a href=\"#\" class=\"card-link\">Another link</a>\n                </div>\n            </div>\n        </span>\n        \n    </div>\n \n\n\n\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.flashMessage.show('You are successfully logged in', {
...
module.exports = "<h2 class=\"page-header\">Register</h2>\n<form (submit) = \"onRegisterSubmit()\"> <!--event creating-->\n      <div class=\"form-group\">\n        <label>Name</label>\n        <!--to access data we use ngModel-->\n          <input type=\"text\" [(ngModel)] = \"name\" [ngModelOptions] = \"{standalone:true}\" name =\"name\"  class=\"form-control\">\n      </div>\n      <div class=\"form-group\">\n          <label>Username</label>\n          <input type=\"text\" [(ngModel)] = \"username\" [ngModelOptions] = \"{standalone:true}\" name =\"username\" class=\"form-control\">\n      </div>\n      <div class=\"form-group\">\n          <label>Email</label>\n          <input type=\"text\" [(ngModel)] = \"email\" [ngModelOptions] = \"{standalone:true}\" name =\"email\" class=\"form-control\">\n      </div>\n      <div class=\"form-group\">\n          <label>Password</label>\n          <input type=\"password\" [(ngModel)] = \"password\" [ngModelOptions] = \"{standalone:true}\" name =\"password\" class=\"form-control\">\n      </div>\n      <input type=\"submit\" class=\"btn btn-primary\" value=\"Submit\">\n</form>"
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show('Something went wrong', { cssClass: 'alert alert-danger', timeout: 3000 });
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(authSrvice, router) {
...
module.exports = __webpack_require__(/*! C:\Users\manee\Desktop\web\meanLab\angular-src\src\main.ts */"./src/main.ts");
